                    ...
                    content += `
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-sm btn-outline-info me-2" onclick="dataUpdateManager.viewStockDetails('${stock.symbol}')" title="View Details">
                                    <i class="fas fa-chart-line"></i>
                                </button>
                                <button class="btn btn-sm btn-outline-danger" onclick="dataUpdateManager.removeStockFromWatchlist(${this.currentWatchlistId}, '${stock.symbol}')" title="Remove Stock">
                                    <i class="fas fa-times"></i>
                                </button>
                            </td>
                        </tr>
